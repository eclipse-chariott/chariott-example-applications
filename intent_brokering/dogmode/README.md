...
This scenario illustrates how you can integrate the vehicle hardware when using the Intent
...
1. The camera application registers with the Intent Brokering service.
